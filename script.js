...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.post-card, .skill-category, .hero-content, .hero-image');
...
const blogPosts = [
    {
        ...
        url: "blog/rust-lifetimes-a-dead-simple-explanation.html"
    },
    {
        id: 2,
        title: "JVM and native code (JNI, JNA, libffi)",
        url: "blog/jvm-and-native-code.html"
    },
    {
        id: 3,
        title: "NodeJS - Mystery Behind process.binding()",
        url: "blog/nodejs-process-binding-mystery.html"
    },
    {
        id: 4,
        title: "Hello World!",
    ...
    {
        id: 5,
        title: "Simple guide to design work stealing thread pool in java",
        url: "https://github.com/nakshay/wstp"
    }
];
...
function loadBlogPosts() {
    ...
    blogPosts.forEach(post => {
        ...
        // If it's an external link (GitHub), open in new tab
